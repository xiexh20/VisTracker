...
echo "VisTracker demo step 1/7: fit SMPLH to keypoints"
python preprocess/fit_SMPLH_30fps.py -s ${seq} -bs 512

echo "VisTracker demo step 2/7: smooth and fit again"
...
echo "VisTracker demo step 3/7: render SMPL-T as triplane"
python render/render_triplane_nr.py -s ${seq}

echo "VisTracker demo step 4/7: run SIF-Net"
...
echo "VisTracker demo step 5/7: run SmoothNet + HVOP-Net"
...
echo "VisTracker demo step 6/7: joint optimization and pack results"
...
echo "VisTracker demo step 7/7: visualization"
