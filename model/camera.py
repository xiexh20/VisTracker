...
class KinectColorCamera:
    ...
    def __init__(self, crop_size=1200, fx=979.7844/2048., fy=979.840/2048.,
                 cx=1018.952/2048., cy=779.486/2048., image_width=2048, image_height=1536):
        ...
        # self.width, self.height = image_width, int(image_width * 0.75) # 4x3 image
        self.width, self.height = image_width, image_height

        # precompute the focal in pixel space
        self.fx_px, self.fy_px = self.fx * image_width, self.fy * image_width
        self.cx_px, self.cy_px = self.cx * image_width, self.cy * image_width
