"""
adapted from: https://github.com/boreshkinai/delta-interpolator/blob/master/src/geometry/quaternions.py
original Author: Boris N. Oreshkin
"""
...
def slerp(q0, q1, t):
    ...
    :return: Interpolated quat (w, x, y, z) : shape = (B, T, J, 4)
     return shape: (B, T, 1, 4)
    """
    assert q0.shape == q1.shape, f'shape does not match: q0={q0.shape}, q1={q1.shape}'
    q0 = q0.unsqueeze(1)
    q1 = q1.unsqueeze(1)
